...
//	public ResultData cancelReactionPoint(int relId) {
//
//		int affectedRow = articleRepository.cancelReactionPoint(relId);
//
//		if (affectedRow == 0) {
//			return ResultData.from("F-1", "해당 게시물은 없습니다", "affectedRow", affectedRow);
//		}
...
//	}
	...
	public ResultData cancelGoodReactionPoint(int relId) {

		int affectedRow = articleRepository.cancelGoodReactionPoint(relId);
	...
	public ResultData cancelBadReactionPoint(int relId) {

		int affectedRow = articleRepository.cancelBadReactionPoint(relId);
